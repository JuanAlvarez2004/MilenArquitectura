...
const Hero = () => {
  return (
    <header className="w-full mt-15 p-20 text-gray-700 text-center md:text-left text-balance flex flex-col md:flex-row items-center justify-center flex-wrap gap-4">
      <section className="w-full md:w-2xl mb-6 md:mb-0">
      ...
      <div id="image-arqs" className="w-full md:w-auto h-64 md:h-96 overflow-hidden">
        <img className="w-full h-full object-cover object-top" src={arqsImg} alt="Arquitectos" title="Valentina y Yamil" />
      </div>
    </header>
  )
}
